...
def add_top_level_item_rows_to_dictionary_of_dataframes(
    ...
    uniclass_top_item_dataframe = dictionary_of_dataframes[TOP_ITEMS_TABLE_NAME]

    for (
        index,
        row,
    ) in uniclass_top_item_dataframe.iterrows():
...
def __add_top_item_row_to_dataframe(
    ...
    for (
        ...
        dictionary_of_dataframes[table_name] = dataframe_with_top_item
...
def __generate_top_level_row_dataframe(
    ...
    if row[CODE_COLUMN_NAME] in dataframe[CODE_COLUMN_NAME][0]:
        top_level_row_dictionary[UUID_COLUMN_NAME] = row[UUID_COLUMN_NAME]
        top_level_row_dictionary[CODE_COLUMN_NAME] = row[CODE_COLUMN_NAME]
        top_level_row_dictionary[TITLE_COLUMN_NAME] = row[TITLE_COLUMN_NAME]
