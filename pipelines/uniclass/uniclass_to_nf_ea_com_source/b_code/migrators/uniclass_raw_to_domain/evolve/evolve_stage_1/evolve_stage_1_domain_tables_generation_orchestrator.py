...
from pipelines.uniclass.uniclass_to_nf_ea_com_source.b_code.migrators.uniclass_raw_to_domain.evolve.evolve_stage_1.domain_tables_data_processor.evolve_stage_1_domain_tables_getter import (
...
def orchestrate_domain_tables_creation_for_evolve_1(
    ...
    evolve_stage_1_domain_tables = get_evolve_stage_1_domain_tables(
        dictionary_of_dataframes=dictionary_of_dataframes,
    )

    evolve_stage_1_folder_path = create_new_folder(
        parent_folder_path=folder_path,
        new_folder_name=EVOLVE_STAGE_1_NAME,
    )

    evolve_stage_1_domain_tables_folder_path = create_new_folder(
    ...
    return evolve_stage_1_domain_tables
