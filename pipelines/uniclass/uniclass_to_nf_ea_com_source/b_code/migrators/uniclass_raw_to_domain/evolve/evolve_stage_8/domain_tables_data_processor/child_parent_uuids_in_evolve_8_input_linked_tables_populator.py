...
def populate_child_parent_uuids_in_evolve_8_input_linked_tables(
    ...
    attribute_table_higher_levels_name_spaces = evolve_8_input_linked_tables.pop(
        ATTRIBUTE_TABLE_HIGHER_LEVELS_NAME_SPACES_TABLE_NAME,
    )
    ...
    attribute_table_higher_levels_name_spaces_with_attributed_object_uuids = __add_attributed_object_uuids_to_table(
    ...
    attribute_table_higher_levels_name_spaces_with_attributed_type_uuids = __add_attributed_type_uuids_to_table(
    ...
    return evolve_8_input_linked_tables_with_child_parent_uuids_populated
...
def __populate_child_uuid_columns_in_linked_tables(
    ...
    return evolve_8_input_linked_tables_with_child_uuids_populated
...
def __populate_parent_uuid_columns_in_linked_tables(
    ...
    return evolve_8_input_linked_tables_with_parent_uuids_populated
...
def __add_attributed_object_uuids_to_table(
    ...
    table_with_attributed_object_uuids = __add_uuids_to_linked_table_columns(
    ...
    return table_with_attributed_object_uuids
...
def __add_attributed_type_uuids_to_table(
    ...
    table_with_attributed_type_uuids = __add_uuids_to_linked_table_columns(
        linked_table=attribute_table_higher_levels_name_spaces,
        evolve_8_domain_tables=evolve_8_object_tables,
...
def __add_uuids_to_linked_table_columns(
    ...
    return linked_table_uuids_populated_slice
