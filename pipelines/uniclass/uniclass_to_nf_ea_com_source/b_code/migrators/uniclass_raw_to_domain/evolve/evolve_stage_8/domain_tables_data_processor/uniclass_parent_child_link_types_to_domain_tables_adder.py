...
def add_uniclass_parent_child_link_types_to_domain_tables(
    ...
    uniclass_parent_child_link_table = evolve_8_domain_tables[
        UNICLASS_PARENT_CHILD_LINK_TABLE_NAME
    ]
...
def __add_rank_column_to_uniclass_parent_child_link_table(
    ...
    uniclass_parent_child_link_table_with_parent_ranks = left_merge_dataframes(
    ...
    return uniclass_parent_child_link_table_with_parent_ranks
...
def __add_connector_types_to_uniclass_parent_child_link_table(
    ...
    uniclass_parent_child_link_table_with_connector_types = left_merge_dataframes(
        master_dataframe=uniclass_parent_child_link_table,
        master_dataframe_key_columns=[
            RANKS_COLUMN_NAME,
        ],
    ...
    return uniclass_parent_child_link_table_with_connector_types
