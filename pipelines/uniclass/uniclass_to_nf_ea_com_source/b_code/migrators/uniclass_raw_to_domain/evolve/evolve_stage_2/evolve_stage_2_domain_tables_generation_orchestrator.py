...
from pipelines.uniclass.uniclass_to_nf_ea_com_source.b_code.migrators.uniclass_raw_to_domain.evolve.evolve_stage_2.domain_tables_data_processor.evolve_stage_2_domain_tables_getter import (
