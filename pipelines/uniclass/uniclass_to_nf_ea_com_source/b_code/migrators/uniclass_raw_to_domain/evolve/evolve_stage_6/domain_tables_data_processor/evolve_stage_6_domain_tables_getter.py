...
from pipelines.uniclass.uniclass_to_nf_ea_com_source.b_code.migrators.uniclass_raw_to_domain.evolve.evolve_stage_6.domain_tables_data_processor.ranks_column_populator import (
    populate_uniclass_objects_table_ranks_column,
)
from pipelines.uniclass.uniclass_to_nf_ea_com_source.b_code.migrators.uniclass_raw_to_domain.evolve.evolve_stage_6.domain_tables_data_processor.uniclass_items_to_ranks_table_creator import (
    create_uniclass_items_to_ranks_table_and_add_to_dictionary,
)
from pipelines.uniclass.uniclass_to_nf_ea_com_source.b_code.migrators.uniclass_raw_to_domain.evolve.evolve_stage_6.domain_tables_data_processor.uniclass_ranks_package_row_to_uuidified_packages_adder import (
    add_uniclass_ranks_package_row_to_uuidified_packages,
)
from pipelines.uniclass.uniclass_to_nf_ea_com_source.b_code.migrators.uniclass_raw_to_domain.evolve.evolve_stage_6.domain_tables_data_processor.uuidified_ranks_table_generator import (
...
def get_evolve_stage_6_domain_tables(
    ...
    return evolve_stage_6_domain_tables
