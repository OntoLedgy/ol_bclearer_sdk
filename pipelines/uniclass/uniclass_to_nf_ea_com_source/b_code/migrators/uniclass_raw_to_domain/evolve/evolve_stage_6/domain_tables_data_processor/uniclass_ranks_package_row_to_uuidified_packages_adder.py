...
from uniclass_to_nf_ea_com_source.b_code.configurations.common_constants.uniclass_bclearer_constants import (
    EA_OBJECT_NAME_COLUMN_NAME, EA_OBJECT_TYPE_COLUMN_NAME, PACKAGE_NAME,
    PARENT_EA_ELEMENT_COLUMN_NAME, UNICLASS_PACKAGE_NAME, UNICLASS_RANKS_NAME,
    UUID_COLUMN_NAME, UUIDIFIED_PACKAGES_TABLE_NAME)
