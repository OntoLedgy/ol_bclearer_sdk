...
def create_uniclass_items_to_ranks_table_and_add_to_dictionary(
    ...
    uniclass_items_to_ranks_table = __get_uniclass_items_to_ranks_table(
        dictionary_of_dataframes=dictionary_of_dataframes,
    )

    uuidified_uniclass_items_to_ranks_table = uuidify_dataframe(
...
def __get_uniclass_items_to_ranks_table(
    ...
    populated_uniclass_items_to_ranks_table = left_merge_dataframes(
    ...
    populated_uniclass_items_to_ranks_table = dataframe_filter_and_rename(
    ...
    return populated_uniclass_items_to_ranks_table
