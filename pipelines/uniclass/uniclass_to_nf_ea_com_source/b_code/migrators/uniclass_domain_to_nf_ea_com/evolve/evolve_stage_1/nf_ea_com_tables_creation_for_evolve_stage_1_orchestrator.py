...
from pipelines.uniclass.uniclass_to_nf_ea_com_source.b_code.migrators.uniclass_domain_to_nf_ea_com.uniclass_nf_ea_com_common.uniclass_to_nf_ea_com_converters.uniclass_packages_converter import (
...
def orchestrate_nf_ea_com_tables_creation_for_evolve_stage_1(
    ...
    nf_ea_com_dictionary = __convert_domain_evolve_stage_1(
...
def __convert_packages(
    ...
    nf_ea_com_dictionary = convert_dictionary_keys_to_packages(
        uniclass_dictionary=uniclass_dictionary,
        nf_ea_com_dictionary=nf_ea_com_dictionary,
...
def __convert_classifiers(
    ...
    for (
        uniclass_table_name,
        uniclass_table,
    ) in uniclass_dictionary.items():
        nf_ea_com_dictionary = convert_uniclass_table_to_classifiers_in_its_own_package(
