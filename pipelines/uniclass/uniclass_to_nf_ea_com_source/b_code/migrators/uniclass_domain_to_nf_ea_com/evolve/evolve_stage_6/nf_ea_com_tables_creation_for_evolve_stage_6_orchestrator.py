...
from uniclass_to_nf_ea_com_source.b_code.configurations.common_constants.uniclass_bclearer_constants import (
    LINKED_TABLE_UNICLASS_ITEMS_TO_RANKS, UNICLASS2015_OBJECT_TABLE_NAME,
    UNICLASS2015_RANKS_TABLE_NAME, UNICLASS_NAMING_SPACES_OBJECTS_TABLE_NAME,
    UNICLASS_PARENT_CHILD_LINK_TABLE_NAME,
    UNICLASS_STEREOTYPES_TYPE_OF_TABLE_NAME, UUIDIFIED_PACKAGES_TABLE_NAME)
