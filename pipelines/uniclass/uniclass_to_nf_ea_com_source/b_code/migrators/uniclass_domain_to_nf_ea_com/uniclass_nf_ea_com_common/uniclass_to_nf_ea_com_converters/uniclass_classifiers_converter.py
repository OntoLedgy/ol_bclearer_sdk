...
def convert_uniclass_table_to_classifiers_in_common_package(
    ...
    nf_ea_com_dictionary = __convert_uniclass_table_to_classifiers_in_package(
...
def __convert_uniclass_table_to_classifiers_in_package(
    ...
    uniclass_table_filtered_and_renamed = dataframe_filter_and_rename(
