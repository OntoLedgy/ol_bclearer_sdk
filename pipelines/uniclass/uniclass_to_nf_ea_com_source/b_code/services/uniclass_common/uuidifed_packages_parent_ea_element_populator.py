...
from uniclass_to_nf_ea_com_source.b_code.configurations.common_constants.uniclass_bclearer_constants import (
    ...
    CONTAINED_EA_CLASSIFIERS_COLUMN_NAME, CONTAINED_EA_DIAGRAMS_COLUMN_NAME,
    CONTAINED_EA_PACKAGES_COLUMN_NAME, EA_GUID_COLUMN_NAME,
    EA_GUIDS_COLUMN_NAME, EA_OBJECT_NAME_COLUMN_NAME,
    EA_OBJECT_NOTES_COLUMN_NAME, EA_OBJECT_STEREOTYPES_COLUMN_NAME,
    EA_OBJECT_TYPE_COLUMN_NAME, EA_PACKAGE_PATH_COLUMN_NAME,
    EA_REPOSITORY_COLUMN_NAME, NF_UUIDS_COLUMN_NAME,
    PARENT_EA_ELEMENT1_COLUMN_NAME, PARENT_EA_ELEMENT_COLUMN_NAME,
    PARENT_EA_ELEMENT_NAME_COLUMN_NAME, PARENT_PACKAGE_EA_GUID_COLUMN_NAME,
    PARENT_PACKAGE_NAME_COLUMN_NAME,
    SUPPLIER_PLACE1_END_CONNECTORS_COLUMN_NAME, UUIDIFIED_PACKAGES_TABLE_NAME)


def populate_uuidified_packages_parent_uuids_column(
    dictionary_of_dataframes: dict,
) -> dict:
    uuidified_packages_dataframe = dictionary_of_dataframes[
    ...
    uuidified_packages_dataframe_with_ea_element_column_populated = left_merge_dataframes(
