...
from pipelines.uniclass.uniclass_to_nf_ea_com_source.b_code.migrators.uniclass_domain_to_nf_ea_com.evolve.evolve_stage_6.nf_ea_com_tables_creation_for_evolve_stage_6_orchestrator import (
...
from pipelines.uniclass.uniclass_to_nf_ea_com_source.b_code.migrators.uniclass_raw_to_domain.evolve.evolve_stage_6.evolve_stage_6_domain_tables_generation_orchestrator import (
...
def orchestrate_evolve_stage_6(
    ...
    uniclass_2024_object_link_rank_tables = orchestrate_domain_tables_creation_for_evolve_6(
    ...
    evolve_stage_6_nf_ea_com_tables = orchestrate_nf_ea_com_tables_creation_for_evolve_stage_6(
        dictionary_of_dataframes=uniclass_2024_object_link_rank_tables,
    )
    ...
    return uniclass_2024_object_link_rank_tables
