...
from pipelines.uniclass.uniclass_to_nf_ea_com_source.b_code.migrators.uniclass_domain_to_nf_ea_com.evolve.evolve_stage_2.nf_ea_com_tables_creation_for_evolve_stage_2_orchestrator import (
...
from pipelines.uniclass.uniclass_to_nf_ea_com_source.b_code.migrators.uniclass_raw_to_domain.evolve.evolve_stage_2.evolve_stage_2_domain_tables_generation_orchestrator import (
...
def orchestrate_evolve_stage_2(
    ...
    uniclass_2024_dictionary_of_dataframes_area_column = orchestrate_domain_tables_creation_for_evolve_2(
    ...
    evolve_stage_2_nf_ea_com_tables = orchestrate_nf_ea_com_tables_creation_for_evolve_stage_2(
        dictionary_of_dataframes=uniclass_2024_dictionary_of_dataframes_area_column,
    )
    ...
    return uniclass_2024_dictionary_of_dataframes_area_column
