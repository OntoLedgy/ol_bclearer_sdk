...
from uniclass_to_nf_ea_com_source.b_code.configurations.common_constants.uniclass_bclearer_constants import (
    ROOT_OUTPUT_FOLDER_TITLE_MESSAGE, UNICLASS_BCLEARER_PREFIX_FOR_NAMES)
...
def orchestrate_uniclass_bclearer(
    ...
    load_stage_4_dictionary_of_dataframes = __orchestrate_uniclass_load_stage(
...
def __orchestrate_uniclass_load_stage(
    ...
    load_stage_4_dictionary_of_dataframes = orchestrate_load_stage_4(
        folder_path=folder_path,
        uniclass_source_data_resource_namespace=uniclass_source_data_resource_namespace,
    )

    return load_stage_4_dictionary_of_dataframes
...
def __orchestrate_uniclass_evolve_stage(
    ...
    evolve_stage_1_dictionary_of_dataframes = orchestrate_evolve_stage_1(
        dictionary_of_dataframes=load_stage_4_dictionary_of_dataframes,
        folder_path=folder_path,
    )

    evolve_stage_2_dictionary_of_dataframes = orchestrate_evolve_stage_2(
        dictionary_of_dataframes=evolve_stage_1_dictionary_of_dataframes,
        folder_path=folder_path,
    )

    evolve_stage_3_dictionary_of_dataframes = orchestrate_evolve_stage_3(
        dictionary_of_dataframes=evolve_stage_2_dictionary_of_dataframes,
        folder_path=folder_path,
    )

    evolve_stage_4_dictionary_of_dataframes = orchestrate_evolve_stage_4(
        dictionary_of_dataframes=evolve_stage_3_dictionary_of_dataframes,
        folder_path=folder_path,
    )

    evolve_stage_5_dictionary_of_dataframes = orchestrate_evolve_stage_5(
        dictionary_of_dataframes=evolve_stage_4_dictionary_of_dataframes,
        folder_path=folder_path,
    )

    evolve_stage_6_dictionary_of_dataframes = orchestrate_evolve_stage_6(
        dictionary_of_dataframes=evolve_stage_5_dictionary_of_dataframes,
        folder_path=folder_path,
    )

    evolve_stage_7_dictionary_of_dataframes = orchestrate_evolve_stage_7(
        dictionary_of_dataframes=evolve_stage_6_dictionary_of_dataframes,
        folder_path=folder_path,
    )

    evolve_stage_8_dictionary_of_dataframes = orchestrate_evolve_stage_8(
