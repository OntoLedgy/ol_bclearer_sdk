...
from pipelines.boson.bclearer_boson_1_1_source.b_code.configurations.getters.boson_1_2e_h_configuration_getter_uml_names_to_named_objects import (
    get_boson_1_2e_h1_configuration_uml_names_to_named_objects,
    get_boson_1_2e_h2_configuration_uml_name_attributes_to_name_objects,
)
from pipelines.boson.bclearer_boson_1_1_source.b_code.configurations.getters.boson_1_2e_i_configuration_getter_attribute_names_to_name_objects import (
    get_boson_1_2e_i1_configuration_name_attributes_to_name_objects,
)
...
def run_visualization_substage_separate_objects_and_names(
    ...
    separated_uml_objects_and_names_universe = __separate_uml_objects_and_names(
...
def __separate_uml_objects_and_names(
    ...
    extracted_uml_names_universe = run_convention_shift_operation_substage(
        ea_tools_session_manager=ea_tools_session_manager,
        content_universe=content_universe,
    ...
    extracted_attribute_names_universe = run_convention_shift_operation_substage(
        ea_tools_session_manager=ea_tools_session_manager,
    ...
    return extracted_attribute_names_universe
