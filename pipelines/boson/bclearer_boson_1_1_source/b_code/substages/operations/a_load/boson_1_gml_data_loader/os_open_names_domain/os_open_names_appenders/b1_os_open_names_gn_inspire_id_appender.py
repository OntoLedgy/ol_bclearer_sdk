...
def append_gn_inspire_id(
    ...
    gn_inspire_id_uuid = create_new_uuid()

    gn_inspire_id_local_id = gn_inspire_id.base_localId.cdata

    gn_inspire_id_namespace = gn_inspire_id.base_namespace.cdata
...
def append_gn_inspire_id_from_href(
    ...
    gn_inspire_id_local_id = xlink_href.split("/")[-1]
