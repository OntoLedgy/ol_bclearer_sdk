...
def append_gn_name(
    ...
    gn_spelling = gn_name.gn_GeographicalName.gn_spelling

    gn_spelling_uuid = create_new_uuid()

    text = gn_spelling.gn_SpellingOfName.gn_text.cdata

    script = gn_spelling.gn_SpellingOfName.gn_script.cdata
