...
def get_boson_1_2e_h1_configuration_uml_names_to_named_objects() -> (
    ...
    convention_shift_operation_configuration_uml_names_to_named_objects = ConventionShiftOperationConfigurations(
    ...
    return convention_shift_operation_configuration_uml_names_to_named_objects
...
def get_boson_1_2e_h2_configuration_uml_name_attributes_to_name_objects() -> (
    ...
    convention_shift_operation_configuration_attribute_names_to_name_objects = ConventionShiftOperationConfigurations(
    ...
    return convention_shift_operation_configuration_attribute_names_to_name_objects
