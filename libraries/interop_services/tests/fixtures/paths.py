...
def data_input_folder_absolute_path():
	...
	data_input_folder_absolute_path = os.path.normpath(os.path.join(base_path, data_input_relative_path)		)	
...
def configurations_folder():
	...
	base_path = os.path.dirname(os.path.abspath(__file__))		
	configurations_folder_absolute_path = os.path.normpath(os.path.join(base_path, configurations_folder_relative_path)		)	
