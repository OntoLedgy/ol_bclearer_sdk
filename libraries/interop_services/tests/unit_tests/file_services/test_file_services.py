...
from bclearer_orchestration_services.b_app_runner_service.logging.logger_initialiser import initialise_logger
...
class TestFileSystemServices():
    ...
    def setup(
        ...
        initialise_logger(
            ...
            output_root_folder=Folders(log_folder)
        )
        self.paths = ["file_services"]

    def test_get_all_files_from_file_system_object_paths(self,storage_interop_services_source_folder):
