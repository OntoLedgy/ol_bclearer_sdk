...
def export_graph_to_excel_with_human_readable_edges(
    ...
    graph_full_filename_root = \
        output_folder.absolute_path_string + os.sep + graph_name
    ...
    source_name_column_name = \
        'source_' + node_name_column_name

    human_readable_edges_table = \
        left_merge_dataframes(
            master_dataframe=edges_table,
            master_dataframe_key_columns=[edge_source_column_name],
            merge_suffixes=['_1, _2'],
            foreign_key_dataframe=nodes_table,
            foreign_key_dataframe_fk_columns=[node_id_column_name],
    ...
    target_name_column_name = \
        'target_' + node_name_column_name

    human_readable_edges_table = \
        left_merge_dataframes(
            master_dataframe=human_readable_edges_table,
            master_dataframe_key_columns=[edge_target_column_name],
            merge_suffixes=['_1, _2'],
            foreign_key_dataframe=nodes_table,
            foreign_key_dataframe_fk_columns=[node_id_column_name],
            foreign_key_dataframe_other_column_rename_dictionary={
