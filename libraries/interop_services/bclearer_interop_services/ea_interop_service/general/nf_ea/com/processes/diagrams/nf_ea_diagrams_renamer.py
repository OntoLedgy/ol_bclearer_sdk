...
from ea_interop_service_source.b_code.i_dual_objects.diagrams.i_dual_diagram import (
    IDualDiagram,
)
from ea_interop_service_source.b_code.i_dual_objects.diagrams.i_null_diagram import (
    INullDiagram,
)
