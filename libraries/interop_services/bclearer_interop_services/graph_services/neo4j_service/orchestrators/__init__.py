...
sys.modules['neo4j_object_models'] = neo4j_object_models
sys.modules['neo4j_orchestrators'] = neo4j_orchestrators
sys.modules['neo4j_constants'] = neo4j_constants
sys.modules['neo4j_configurations'] = neo4j_configurations