...
from bclearer_interop_services.graph_services.neo4j_service.object_models.neo4j_sessions import Neo4jSession
...
class Neo4jConnections:
    def __init__(
        ...
        if self.external_driver:
            ...
            self.driver = self.get_driver(max_connection_pool_size)

    def get_driver(self, max_connection_pool_size=None):
    ...
    def get_new_session(self, database_name=None):
