...
def convert_graph_to_nodes_and_edges_tables(
        ...
        -> tuple:
    nodes_table = \
        extract_nodes_table_from_graph(
            graph=graph,
...
def extract_nodes_table_from_graph(
        ...
        -> DataFrame:
    graph_nodes_dictionary = \
        extract_nodes_table_as_dictionary_of_rows_from_graph(
            graph=graph,
...
def extract_nodes_table_as_dictionary_of_rows_from_graph(
    ...
    for graph_nodes_dictionary_key, graph_nodes_dictionary_row \
