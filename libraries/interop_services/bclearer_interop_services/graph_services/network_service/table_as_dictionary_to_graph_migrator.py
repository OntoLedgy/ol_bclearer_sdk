...
def __add_row_dictionary_to_edges_container(
    ...
    if edge_attribute_column_names:
        for edge_attribute_column_name \
                in edge_attribute_column_names:
            edge_attributes_dictionary[edge_attribute_column_name] = \
                row_dictionary[edge_attribute_column_name]
