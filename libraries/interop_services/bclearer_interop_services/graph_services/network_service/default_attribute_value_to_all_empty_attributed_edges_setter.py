...
from bclearer_interop_services.graph_services.network_service.attribute_to_edge_setter import set_attribute_to_edge
...
def set_default_attribute_value_to_all_empty_attributed_edges(
    ...
    empty_attributed_edges = \
        [
            ...
            for source_node, target_node, attribute_dictionary in graph.edges(data=True)
            if attribute_dictionary == dict()
        ]

    for empty_attributed_edge \
