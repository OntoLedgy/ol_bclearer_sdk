...
def get_all_files_from_file_system_object_paths(
        ...
        base_root_path: str = str(),
        dot_extension_string: str = str(),
    ...
    primary_grammar_files = \
        list()

    for primary_grammar_file_system_object \
            in file_system_objects:
        if isinstance(primary_grammar_file_system_object, Files):
            primary_grammar_files.append(
                primary_grammar_file_system_object)

        elif isinstance(primary_grammar_file_system_object, Folders):
