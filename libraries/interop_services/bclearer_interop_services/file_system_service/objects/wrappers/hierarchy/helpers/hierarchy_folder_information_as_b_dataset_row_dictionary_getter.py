...
def get_hierarchy_folder_information_as_b_dataset_row_dictionary(
    ...
    if not isinstance(hierarchy_file_system_object_register, HierarchyFileSystemObjectRegisters):
        raise \
            TypeError

    folder = \
        hierarchy_file_system_object_register.get_file_system_object_from_hierarchy_object(
    ...
    hierarchy_folder_as_b_dataset_row_dictionary = \
        {
            ...
            'hierarchy_file_system_object_type': type(hierarchy_folder).__name__,
            'child_count': str(hierarchy_folder.get_child_hierarchy_object_count()),
            ...
            'length': str(folder.file_system_object_properties.length),
