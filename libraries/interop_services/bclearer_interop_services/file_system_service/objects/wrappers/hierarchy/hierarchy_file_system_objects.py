...
class HierarchyFileSystemObjects:
    def __init__(
        ...
        if parent_hierarchy_folder and not isinstance(parent_hierarchy_folder, HierarchyFolders):
            raise \
                TypeError
    ...
    def __add_to_parent_hierarchy_folder(
        ...
        self.parent_hierarchy_folder.child_hierarchy_file_system_objects.add(self)
