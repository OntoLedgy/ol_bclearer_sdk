...
from bclearer_interop_services.file_system_service.objects.path_properties import PathProperties
...
class FileSystemObjects:
    def __init__(
        ...
        if os.path.exists(absolute_path_string):
            self.file_system_object_properties = \
                PathProperties(
