...
class BIdentityFileSystemObjectUniverses:
    ...
    def export_universe_in_b_datasets_format(
        ...
        universe_in_b_datasets_format = self.b_identity_file_system_object_universe_registers.export_register_in_b_datasets_format()
    ...
    def get_universe_output_root_folder(
        ...
        if self.universe_output_root_folder:
            return self.universe_output_root_folder
