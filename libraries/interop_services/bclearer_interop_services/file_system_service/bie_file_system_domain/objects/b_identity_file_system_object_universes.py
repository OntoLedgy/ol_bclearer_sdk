...
from nf_common.code.services.datetime_service.time_helpers.time_getter import now_time_as_string_for_files
...
from bclearer_interop_services.file_system_service.bie_file_system_domain.objects.b_identity_folders import \
    BIdentityFolders
from bclearer_interop_services.file_system_service.new_folder_creator import create_new_folder
...
class BIdentityFileSystemObjectUniverses:
    def __init__(
        ...
        self.b_identity_file_system_object_universe_registers = \
            BIdentityFileSystemObjectUniverseRegisters(
        ...
        self.universe_output_root_folder: Optional[Folders] = None
    ...
    def get_universe_output_root_folder(
            ...
            -> Folders:
        if self.universe_output_root_folder:
            return \
                self.universe_output_root_folder

        universe_output_root_folder_path = \
            create_new_folder(
                parent_folder_path=universe_output_parent_folder.absolute_path_string,
                new_folder_name='b_identity_fso_universe_' + now_time_as_string_for_files())
