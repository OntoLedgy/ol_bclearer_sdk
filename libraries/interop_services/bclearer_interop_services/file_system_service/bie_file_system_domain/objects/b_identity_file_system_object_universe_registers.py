...
from bclearer_interop_services.file_system_service.objects.wrappers.hierarchy.hierarchy_folders import \
    HierarchyFolders
from nf_common.code.services.reporting_service.wrappers.run_and_log_function_wrapper import run_and_log_function
...
class BIdentityFileSystemObjectUniverseRegisters:
    def __init__(
        ...
        if not isinstance(owning_b_identity_file_system_object_universe, BIdentityFileSystemObjectUniverses):
            raise \
                TypeError
        ...
        if not isinstance(root_file_system_object, Folders):
            raise \
                TypeError
        ...
        self.hierarchy_file_system_object_register = \
            HierarchyFileSystemObjectRegisters(
                owning_object=self,
    ...
    def __populate_mapping_dictionary(
        ...
        for hierarchy_file_system_object, file_system_object \
    ...
    def __populate_id_b_identity_component_id_sums(
            self) \
            -> None:
        for b_identity_file_system_object, hierarchy_file_system_object \
                in self.b_identity_file_system_objects_to_hierarchy_file_system_objects_mapping.items():
            if isinstance(b_identity_file_system_object, BIdentityFolders):
    ...
    def add_b_identity_file_system_object_to_hierarchy_file_system_objects_map_to_register(
            ...
            -> None:
        self.b_identity_file_system_objects_to_hierarchy_file_system_objects_mapping[b_identity_file_system_object] = \
            hierarchy_file_system_object

    def get_identity_b_identity_file_system_object_from_hierarchy_object(
            self,
            hierarchy_file_system_object) \
            -> Optional[BIdentityFileSystemObjects]:
        ...
        identity_b_identity_file_system_objects = [
            ...
            for identity_b_identity_file_system_object, current_hierarchy_file_system_object
            in self.b_identity_file_system_objects_to_hierarchy_file_system_objects_mapping.items()
        ...
        if identity_b_identity_file_system_objects:
            return \
                identity_b_identity_file_system_objects[0]
    ...
    def get_identity_hierarchy_file_system_object_from_b_identity_object(
            ...
            -> HierarchyFileSystemObjects:
        identity_hierarchy_file_system_object = \
            self.b_identity_file_system_objects_to_hierarchy_file_system_objects_mapping[b_identity_file_system_object]
    ...
    def get_hierarchy_file_system_object_by_uuid(
            ...
            -> Optional[HierarchyFileSystemObjects]:
        for hierarchy_file_system_object \
                in self.b_identity_file_system_objects_to_hierarchy_file_system_objects_mapping.values():
    ...
    def export_register_in_b_datasets_format(
        ...
        for hierarchy_file_system_object_register_in_b_datasets_format_uuid, \
