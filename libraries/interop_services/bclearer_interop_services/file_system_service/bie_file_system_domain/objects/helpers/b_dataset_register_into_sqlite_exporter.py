from bclearer_interop_services.dataframe_service.all_cells_to_string_converter import convert_all_cells_to_string
...
from bclearer_interop_services.relational_database_services.sqlite_service.sqlite_database_creator import create_sqlite_database
...
def export_register_into_sqlite(
    ...
    dictionary_as_table_string_cells = \
