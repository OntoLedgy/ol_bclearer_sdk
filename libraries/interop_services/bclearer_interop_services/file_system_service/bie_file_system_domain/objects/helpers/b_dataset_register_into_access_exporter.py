...
def export_b_dataset_register_into_access(
    ...
    register_output_file_base_name = \
        register_output_string_name_root + '_register'

    register_output_root_folder_path = \
        create_new_folder(
            parent_folder_path=output_folder.absolute_path_string,
            new_folder_name=register_output_string_name_root + '_' + now_time_as_string_for_files())

    register_output_folder = \
        Folders(
