...
def add_b_identity_columns_to_register_in_b_dataset_format(
    ...
    if not isinstance(b_identity_file_system_object_universe_register, BIdentityFileSystemObjectUniverseRegisters):
        raise \
            TypeError

    hierarchy_file_system_object = \
        b_identity_file_system_object_universe_register.get_hierarchy_file_system_object_by_uuid(
    ...
    b_identity_file_system_object = \
        b_identity_file_system_object_universe_register.get_identity_b_identity_file_system_object_from_hierarchy_object(
            hierarchy_file_system_object=hierarchy_file_system_object)

    parent_b_identity_file_system_object = \
        b_identity_file_system_object_universe_register.get_identity_b_identity_file_system_object_from_hierarchy_object(
    ...
    universe_in_b_datasets_format_row_dictionary = \
        {
            ...
            'b_identity_file_system_object_types': type(b_identity_file_system_object).__name__,
    ...
    elif isinstance(b_identity_file_system_object, BIdentityFiles):
        universe_in_b_datasets_format_row_dictionary.update(
            {
