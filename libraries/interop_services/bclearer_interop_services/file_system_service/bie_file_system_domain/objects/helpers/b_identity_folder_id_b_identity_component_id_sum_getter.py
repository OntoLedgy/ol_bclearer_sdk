...
def get_b_identity_folder_id_b_identity_component_id_sum(
    ...
    if not isinstance(b_identity_file_system_object_registry, BIdentityFileSystemObjectUniverseRegisters):
        raise \
            TypeError
    ...
    #  - to be discussed
    for hierarchy_folder_child_object \
            in hierarchy_folder.child_hierarchy_file_system_objects:
        b_identity_child_object = \
            b_identity_file_system_object_registry.get_identity_b_identity_file_system_object_from_hierarchy_object(
