...
def add_b_identity_to_hierarchy_register_map_entry_to_dictionary(
    ...
    if hierarchy_file_system_object == b_identity_file_system_object_universe_register.hierarchy_file_system_object_register.root:
        return

    if isinstance(hierarchy_file_system_object, HierarchyFolders) \
            and isinstance(file_system_object, Folders):
    ...
    elif isinstance(file_system_object, Files):
        b_identity_file_system_object = \
            BIdentityFiles(
