from bclearer_core.common_knowledge.bclearer_matched_ea_objects import BclearerMatchedEaObjects
from bclearer_core.common_knowledge.bclearer_additional_column_types import BclearerAdditionalColumnTypes
from bclearer_core.common_knowledge.bclearer_constants import NAME_INSTANCE_ATTRIBUTE_NAME
...
from bclearer_core.substages.operations.b_evolve.common.new_root_package_creator import create_root_package
from bclearer_core.substages.operations.b_evolve.convention_shift_operations.convention_shifters.separate_names_and_instances.ea_attribute_remover import remove_ea_attributes
from bclearer_core.substages.operations.b_evolve.convention_shift_operations.convention_shifters.separate_names_and_instances.name_instance_creator import create_name_instance
from bclearer_core.substages.operations.b_evolve.convention_shift_operations.convention_shifters.separate_names_and_instances.name_instance_type_creator import create_name_instance_type
from bclearer_core.substages.operations.common.new_ea_objects_dictionary_creator import create_new_ea_objects_dictionary
from bclearer_core.substages.operations.common.nf_ea_com_universe_updater import update_nf_ea_com_universe_with_dictionary
from bclearer_core.substages.operations.common.nf_uuid_from_ea_guid_from_collection_getter import get_nf_uuid_from_ea_guid_from_collection
