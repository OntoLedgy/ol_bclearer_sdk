...
def get_all_package_and_subpackages_classifiers(
    ...
    content_universe_ea_packages = content_universe.nf_ea_com_registry.get_ea_packages()
    ...
    domain_classes_classifiers_table = domain_objects_classifiers_table[
        domain_objects_classifiers_table[ea_object_type_column_name]
    ...
    return domain_classes_classifiers_table
