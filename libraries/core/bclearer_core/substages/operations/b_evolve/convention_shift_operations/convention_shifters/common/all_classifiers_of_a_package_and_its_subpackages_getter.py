from bclearer_core.substages.operations.b_evolve.convention_shift_operations.convention_shifters.common.list_of_contained_packages_of_a_package_getter import get_list_of_all_contained_packages_of_package
