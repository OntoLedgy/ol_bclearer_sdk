from bclearer_core.substages.operations.b_evolve.adjustment_operations.convert_attributes_to_associations.content_adjustment_universes_nf_uuids_mapper import get_mapped_nf_uuid_from_mapped_universe
