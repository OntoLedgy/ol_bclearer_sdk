...
def get_uuidified_dataframe_name(
    ...
    uuidified_dataframe_name = __get_separated_uuid_column(
        UUIDIFIED_DATAFRAME_PREFIX,
        dataframe_name,
    )
...
def get_common_uuidification_table_name(
    ...
    common_uuidification_table_name = __get_separated_uuid_column(
        prefix,
        table_type_name,
    )

    return common_uuidification_table_name
...
def __get_separated_uuid_column(
    ...
    separated_uuid_column = prefix + UUID_COLUMN_NAME_SEPARATOR + suffix
