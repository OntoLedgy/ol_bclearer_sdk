...
def create_bclearer_load_configuration(
        ...
        -> BclearerLoadConfigurations:
    identity_hash_configuration_list = \
        __get_list_from_configuration(
    ...
    core_content_hash_configuration_list = \
        __get_list_from_configuration(
            configuration_dataframe=configuration_dataframe,
            key_name=CORE_CONTENT_HASHES_CONFIGURATION_NAME)

    content_hash_configuration_list = \
        __get_list_from_configuration(
            configuration_dataframe=configuration_dataframe,
...
def __get_list_from_configuration(
        ...
        key_name: str) \
        -> list:
    if key_name not in set(configuration_dataframe[KEY_NAMES_CONFIGURATION_COLUMN_NAME]):
        return \
            list()

    configuration_value = \
        configuration_dataframe.loc[configuration_dataframe[KEY_NAMES_CONFIGURATION_COLUMN_NAME] == key_name, VALUES_CONFIGURATION_COLUMN_NAME].iloc[0]
