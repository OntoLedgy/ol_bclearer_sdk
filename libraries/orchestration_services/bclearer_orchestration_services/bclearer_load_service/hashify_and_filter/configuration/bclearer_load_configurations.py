class BclearerLoadConfigurations:
    def __init__(
            ...
            -> None:
        self.identity_hash_configuration_list = \
        ...
        self.core_content_hash_configuration_list = \
            core_content_hash_configuration_list

        self.content_hash_configuration_list = \
            content_hash_configuration_list

        self.columns_in_scope_configuration_list = \
