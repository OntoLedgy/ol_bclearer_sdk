def split_string_by_separators(
        ...
        separators: list) \
        -> list:
    split_stage_string_tuples = \
        list()

    strings_to_split = \
        [string_content]

    for separator_position in range(len(separators)):
        split_list = \
            __split_list_of_strings_by_separator(
...
def __split_string_by_separator(
    ...
    for split_string in split_list:
        split_stage_string_tuples.append(
            (current_separator_position, split_string))
