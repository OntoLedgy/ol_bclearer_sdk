...
def convert_radon_json_to_dataframes(
    ...
    cyclomatic_complexity_radon_dataframe = \
        convert_cyclomatic_complexity_radon_json_to_dataframe(
            results_as_json=results_as_json[EnumRadonCodeMetricsTypes.CYCLOMATIC_COMPLEXITY])
    ...
    maintainability_index_radon_dataframe = \
        convert_maintainability_index_radon_json_to_dataframe(
            results_as_json=results_as_json[EnumRadonCodeMetricsTypes.MAINTAINABILITY_INDEX])
