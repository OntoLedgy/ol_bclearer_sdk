...
def export_analysis_dataframes_to_access(
    ...
    dataframes_dictionary_keyed_on_name_string = \
        __convert_dictionary_to_keyed_on_name_string(
...
def __convert_dictionary_to_keyed_on_name_string(
    ...
    for code_analysis_type, dataframe in analysis_dataframes_dictionary.items():
...
def __add_dataframe_to_dictionary(
    ...
    dataframe_name = \
        enum_code_analysis_types_to_table_names_mapping[code_analysis_type]

    dataframes_dictionary_keyed_on_name_string[dataframe_name] = \
        dataframe
