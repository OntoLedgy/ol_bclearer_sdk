from bclearer_interop_services.b_dictionary_service.python_extension_services import join_dictionaries
...
def orchestrate_static_code_analysis(
        static_code_analysis_flow_configuration: StaticCodeAnalysisFlowConfigurations) -> dict:
    ...
    all_analysis_dataframes_dictionary = \
        join_dictionaries(
            dictionaries=
            [
                radon_code_metrics_dataframes_dictionary,
