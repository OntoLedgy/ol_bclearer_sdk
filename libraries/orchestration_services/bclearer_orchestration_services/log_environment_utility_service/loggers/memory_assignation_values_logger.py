...
from nf_common.code.services.log_environment_utility_service.common_loggers import CommonLoggers
from nf_common.code.services.log_environment_utility_service.helpers.units_converter import convert_units
...
def __log_environment_name_value_pair(
    ...
    logger.info(
        msg=NAME_VALUE_DELIMITER.join(message_list))
