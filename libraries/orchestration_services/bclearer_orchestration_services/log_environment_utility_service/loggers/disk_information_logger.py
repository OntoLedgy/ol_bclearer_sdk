...
from bclearer_orchestration_services.log_environment_utility_service.helpers.logger_helper import log_environment_section
...
def __add_partition_name_values(
    ...
    partition_name_values = \
        {
            prefix + ' ' + DISK_INFORMATION_TOTAL_SIZE: f'{convert_units(partition_usage.total)}',
