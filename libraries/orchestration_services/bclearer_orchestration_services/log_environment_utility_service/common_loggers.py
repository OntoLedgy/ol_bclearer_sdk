...
from nf_common.code.services.reporting_service.wrappers.run_and_log_function_wrapper import log_timing_header
...
class CommonLoggers(
    ...
    def read_log_file_content(
        ...
        with open(file_handler.absolute_path_string) as text_io_wrapper_file:
            log_lines = \
    ...
    def get_error_messages_by_log_type(
        ...
        log_datatable_by_error_type = \
            log_datatable[log_datatable.log_message.str.contains(
                log_type.upper())]
