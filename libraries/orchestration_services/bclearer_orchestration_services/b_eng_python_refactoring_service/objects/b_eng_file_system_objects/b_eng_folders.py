...
class BEngFolders(Folders):
    ...
    def __init__(
        ...
        self.b_eng_folder_type = b_eng_folder_type

        self.alternative_name = alternative_name

        BEngFolders.registry_keyed_on_full_paths[absolute_path_string] = self
    ...
    def bitbucket_team_name(
        ...
        if self.b_eng_folder_type == EnumBEngFolderTypes.BITBUCKET_TEAM:
            return self.base_name

        if self.b_eng_folder_type == EnumBEngFolderTypes.WORKSPACE:
            return ""
    ...
    def bitbucket_project_name(
        ...
        if self.b_eng_folder_type == EnumBEngFolderTypes.BITBUCKET_PROJECT:
            return self.base_name
    ...
    def git_repository_name(
        ...
        if self.b_eng_folder_type == EnumBEngFolderTypes.CODE_REPOSITORY:
            return self.base_name

        if self.b_eng_folder_type == EnumBEngFolderTypes.CREATED_DATA_REPOSITORY:
            return self.base_name

        if self.b_eng_folder_type == EnumBEngFolderTypes.ORIGINAL_DATA_REPOSITORY:
            return self.base_name
