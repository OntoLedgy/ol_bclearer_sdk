...
def create_move_and_replace_configuration(
    ...
    path_couples_ordered_indexed_list = \
        get_path_couples_ordered_indexed_list(
    ...
    in_scope_bitbucket_project_list = \
        get_in_scope_b_eng_project_list(
            b_eng_workspace_folder=b_eng_workspace_folder,
...
def get_path_couples_ordered_indexed_list(
    ...
    for index, relative_path_string_couple in dictionary_of_relative_path_string_couples.items():
...
def get_in_scope_b_eng_project_list(
    ...
    in_scope_b_eng_project_folder_list = \
        BEngProjectFolderLists(
