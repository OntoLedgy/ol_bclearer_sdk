...
class BEngWorkspaceWithFileSystemObjectCouplesOrderedIndexedLists:
    ...
    def __init__(
        ...
        self.b_eng_workspace_file_system_object_couples_ordered_indexed_list = \
            b_eng_workspace_file_system_object_couples_ordered_indexed_list

    def get_indexed_file_system_object_couple(
            self,
            index):
        indexed_file_system_object_couple = \
            self.b_eng_workspace_file_system_object_couples_ordered_indexed_list.get_path_couple_with_index(
                index)
