...
def b_eng_folders_and_files_refactor_checks(
        ...
        in_scope_b_eng_project_folder_list: BEngProjectFolderLists) \
            -> bool:
    check_result = \
        __check_b_eng_workspace_folder_exists(
    ...
    check_result = \
        __check_b_eng_project_folders_exist(
...
def __check_b_eng_project_folders_exist(
    ...
    for b_eng_project_folder in b_eng_project_folder_list.list:
        b_eng_project_exists = \
            __check_b_eng_project_folder_exists(
...
def __report_file_system_object_does_not_exist(
    ...
    message = \
        type_name + ' does not exist: ' + file_system_object.absolute_path_string
