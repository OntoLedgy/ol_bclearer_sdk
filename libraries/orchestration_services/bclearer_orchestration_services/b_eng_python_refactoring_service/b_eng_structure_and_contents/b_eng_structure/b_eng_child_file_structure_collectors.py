...
def collect_child_files_structure(
    ...
    file_names = \
        [file_name for file_name in os.listdir(parent_folder.absolute_path_string)
         if os.path.isfile(os.path.join(parent_folder.absolute_path_string, file_name))]
...
def __collect_child_file_if_required(
    ...
    b_eng_file = \
        BEngFiles(
            absolute_path_string=os.path.join(parent_folder.absolute_path_string, file_name),
            parent_folder=parent_folder,
