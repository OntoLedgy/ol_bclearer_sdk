...
def collect_child_folders_structure(
    ...
    child_folder_names = \
        [child_folder_name for child_folder_name in glob.glob(parent_folder.absolute_path_string + "/**/", recursive=False)]
...
def __check_is_required(
        ...
        parent_folder: BEngFolders) -> bool:
    ...
    if (parent_folder.b_eng_folder_type == EnumBEngFolderTypes.BITBUCKET_PROJECT and
            b_eng_folder_type != EnumBEngFolderTypes.GIT_REPOSITORIES):
        return \
            False
